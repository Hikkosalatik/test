            ...
            workspace.DescendantAdded:Connect(function(obj)
                task.defer(function()
                    if _G.deferOptimization then
                        table.insert(unoptimizedDuringDefer, obj)
                    else
...
local function WaitForEventGround()
    ...
    task.wait(30)
    _G.deferOptimization = false 
    for i = 1, #unoptimizedDuringDefer do
        local obj = unoptimizedDuringDefer[i]
    ...
    table.clear(unoptimizedDuringDefer)
end
